...
def test_get_id_from_file_projects(scraper):
    results = scraper.get_ids_from_file("../fixtures/projects.txt")
...
def test_get_id_from_file_studios(scraper):
    results = scraper.get_ids_from_file("../fixtures/studios.txt")
...
def test_get_id_from_file_nonexistent_file(scraper):
    results = scraper.get_ids_from_file("../fixtures/nonexistent.txt")
